        ...
        module Postgres
          class << self
            ...
            def watched_files_patterns
              [
                File.join(__dir__, "../../..", "generators/logidze/install/pg/functions/*.sql"),
                File.join(__dir__, "../../..", "generators/logidze/install/pg/templates/*")
              ]
            end
            ...
            def function_paths
              Dir.glob(
                File.join(
                  __dir__, "..", "..", "..", "generators", "logidze", "install", "pg", "functions", "*.sql"
                )
              )
            end
