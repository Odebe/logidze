...
params3 = Benchmarker.fake_params
params4 = Benchmarker.fake_params
params5 = Benchmarker.fake_params
...
Benchmark.ips do |x|
  ...
  x.report("Plain UPDATE #2") do
    ...
    user.update!(params3.except(*JSON_COLUMNS))
    user.update!(params4.slice(*JSON_COLUMNS))
    user.update!(params5.except(*JSON_COLUMNS))
    user.update!(params5.slice(*JSON_COLUMNS))
  end
